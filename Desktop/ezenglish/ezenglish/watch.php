<!DOCTYPE html>
<html>
	<title><?php include('getTitle.php') ?></title>
	<meta charset="UTF-8">
	...
	<script type="text/jscript" src="jquery-3.3.1.js"></script>
	...
	<body onload="check()" class="w3-light-grey w3-content" style="max-width:1600px">
	  	...
	  	<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:200px;" id="mySidebar"><br>
			<div class="w3-container">
		  	...
		  	<div class="w3-bar-block">
		      	<a href="home.html" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Home</a>
		      	<a href="login/login.html" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user fa-fw w3-margin-right"></i>Login</a>
		  	</div>
	  	</nav>
		...
		<div class="w3-main" style="margin-left:200px">
			...
			<div id = "recordArea" style="display:none">
				...
				<button type="button" class="btn btn-outline-success" id="btn-stop-recording" disabled>Done</button>
				<h2>辨識結果:</h2>
				<span style="color:red;font-size:36px;font-weight:bold;" id="answerArea"></span>
			</div>
